...
MappingAV45 <- read.csv("/Users/fahadmehfooz/Downloads/train_encodings_umap_ndl.csv")
TestMappingAV45 <- read.csv("/Users/fahadmehfooz/Downloads/test_encodings_umap_ndl.csv")
colors <- rev(colorRampPalette(brewer.pal(11, 'Spectral')[-6])(100))

# Convert DXGrp to factor with BIOLOGICAL ORDERING
...
# Get pseudotime for training data
...
png("/Users/fahadmehfooz/Desktop/AE/SLOPE/Temp Files/Plot1_train_vs_pseudotime_ndl.png")
...
png("/Users/fahadmehfooz/Desktop/AE/SLOPE/Temp Files/Plot2_train_boxplot_ndl.png")
...
png("/Users/fahadmehfooz/Desktop/AE/SLOPE/Temp Files/Plot3_train_scatter_vs_dxg_ndl.png")
...
# Plot 1: Train data vs Pseudotime along with principal curve
png("/Users/fahadmehfooz/Desktop/AE/SLOPE/Temp Files/Plot1_test_vs_pseudotime_ndl.png")
...
png("/Users/fahadmehfooz/Desktop/AE/SLOPE/Temp Files/Plot2_test_boxplot_ndl.png")

# Pseudotime across different diagnosis group
ggboxplot(TestMappingAV45, x = "DX", y = "Pseudotime_Normalized",
          fill = "DX",ylab = "Pseudotime",xlab = "Diagnosis Groups")+ 
  stat_compare_means(comparisons = my_comparisons,aes(label = ..p.signif..),
                     method = "t.test", size = 5)+
  ggtitle("Pseudotime Vs Diagnosis Groups") +
  theme(standard_theme,  plot.title = element_text(hjust = 0.5))
...
png("/Users/fahadmehfooz/Desktop/AE/SLOPE/Temp Files/Plot3_test_scatter_vs_dxg_ndl.png")
...
write.csv(MappingAV45[, c("UMAP1", "UMAP2", "DXGrp", "DX", "RID", "AGE", "VISCODE2", "SlingFusedPhatePseu", "Pseudotime_Normalized")], 
          file = "/Users/fahadmehfooz/Desktop/AE/SLOPE/Temp Files/Psuedotime_train_ndl.csv", 
          row.names = FALSE)


write.csv(TestMappingAV45[, c("UMAP1", "UMAP2", "DXGrp", "DX", "RID", "AGE", "VISCODE2", "SlingFusedPhatePseu", "Pseudotime_Normalized")], 
          file = "/Users/fahadmehfooz/Desktop/AE/SLOPE/Temp Files/Psuedotime_test_ndl.csv", 
          row.names = FALSE)
graphics.off()
